...
TAGGED_NEW="https://github.com/GerardoRosas-27/naves-arcade/releases/download/v1.0.2-mobile/naves-arcade.apk"
LATEST="https://github.com/GerardoRosas-27/naves-arcade/releases/latest/download/naves-arcade.apk"
TAGGED_OLD="https://github.com/GerardoRosas-27/naves-arcade/releases/download/v1.0.1-mobile/naves-arcade.apk"
echo Fetching_APK
if ! curl -fL --retry 3 --retry-delay 2 -o downloads/naves-arcade.apk "$TAGGED_NEW"; then
  ...
  if ! curl -fL --retry 3 --retry-delay 2 -o downloads/naves-arcade.apk "$LATEST"; then
    echo fallback_old_tagged
    curl -fL --retry 3 --retry-delay 2 -o downloads/naves-arcade.apk "$TAGGED_OLD"
  fi
fi
